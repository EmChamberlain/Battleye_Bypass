...
std::vector<std::string> vehicleGNameVec = { "Uaz", "Buggy", "Dacia", "BP_Motorbike", "Boat_PG117", "AquaRail", "BP_PickupTruck", "BP_Van", "PG117"};
